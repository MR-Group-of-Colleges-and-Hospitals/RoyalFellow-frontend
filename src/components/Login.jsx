        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* Password */}
              <div>
                {/* <div className="mt-2 text-sm bg-[#A68340] text-[#DDBC7E] border border-[#A68340] px-3 py-2 rounded-md shadow-sm">
                  <p>
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full flex justify-center py-3 px-4 rounded-lg text-white bg-[#A68340] hover:bg-[#DDBC7E] ${
              ...
              <p className="text-center text-sm text-gray-600 mt-4">
                ...
                <Link
                  to="/"
                  className="font-semibold text-[#A68340] hover:underline"
                >
                  Create one
                </Link>
              </p>
              ...
              <div className="text-center text-sm text-gray-600 mt-4">
                <Link
                  to="/forgot-password"
                  className="text-sm font-medium text-[#A68340] hover:underline"
                >
