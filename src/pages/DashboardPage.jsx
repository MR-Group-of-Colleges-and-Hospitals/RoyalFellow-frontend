    ...
    <section className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[#A68340] leading-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-full mx-auto">
        ...
        >
          <div className="p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-[#A68340]/10 p-3 rounded-xl">
                <UserOutlined className="text-[#A68340] text-lg" />
              </div>
              <h3 className="text-xl font-bold text-[#A68340] m-0">
                Personal Details
              </h3>
            </div>
        ...
        {scholarship > 0 ? (
          <Card
            ...
            bodyStyle={{ padding: 0 }}
          >
            <div className="bg-gradient-to-br from-[#A68340] to-[#A68340] p-6 min-h-[260px] flex flex-col">
              <div className="flex items-center gap-3 mb-4">
          ...
          <Card className="shadow-lg border-0 rounded-2xl">
            <div className="p-6">
                <h3 className="text-lg font-semibold text-[#A68340] mb-2">
                Scholarship
              </h3>
          ...
          <div className="p-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              <Tooltip title="Download ID Card">
                <a
                  href="/id-card"
                  className="px-3 py-2 rounded-xl bg-[#A68340] text-[#A68340] text-sm hover:opacity-95"
                >
                  Get ID
                </a>
              </Tooltip>
              <Tooltip title="View Fee Status">
                <a
                  href="/payment-status"
                  className="px-3 py-2 rounded-xl bg-gray-100 text-[#A68340] text-sm hover:bg-gray-200"
                >
                  Payments
                </a>
              </Tooltip>
...
const DetailItem = ({ icon, label, value }) => (
  <div className="flex items-center justify-between px-3 py-3 rounded-xl group transition-colors hover:bg-gray-50">
    <div className="flex items-center gap-3 min-w-0">
      <span className="text-[#A68340] text-base shrink-0">{icon}</span>
      <span className="text-gray-600">{label}</span>
    </div>
    <span className="text-[#A68340] font-semibold text-right max-w-[60%] truncate">
      {value}
    </span>
  </div>
);
