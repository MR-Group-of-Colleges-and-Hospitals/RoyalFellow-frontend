  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mb-6 border border-gray-100">
        <h2 className="text-3xl font-bold text-[#A68340]">Payment Status</h2>
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-6 py-3 text-sm font-medium transition-all duration-200 rounded-md flex-1 text-center
              ${
                activeTab === tab.id
              ? "bg-[#A68340] text-white shadow-md cursor-pointer"
              : "text-gray-600 hover:text-[#A68340] hover:bg-gray-50 cursor-pointer"
              }`}
          >
            {tab.label}
          </button>
  ...
  if (filteredBills.length === 0) {
    return (
      <div className="p-8 text-center">
        ...
        <h3 className="text-xl text-[#A68340] font-light mb-2">
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <h4 className="font-medium text-[#A68340]">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-lg font-semibold text-[#A68340]">
                  ₹{ins.amount}
                </span>
            ...
            {openIndex === index && (
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <p className="text-[#A68340]">{ins.amount_word}</p>

                  <p><span className="text-gray-600">Payment Type:</span></p>
                  <p className="text-[#A68340]">{ins.pay_type}</p>

                  <p><span className="text-gray-600">Due Date:</span></p>
                  <p className="text-[#A68340]">
                    {ins.ins_due_date
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 bg-[#A68340] text-white rounded-md cursor-pointer"
                >
                  View Full Details
                </button>
              </div>
      ...
      {selectedInstallment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-2xl rounded-xl shadow-xl overflow-hidden">
            <div className="bg-[#A68340] text-white p-6 flex justify-between">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={index}>
                    ...
                    <p className="text-[#A68340]">{item.value}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div className="text-2xl font-light text-[#A68340]">{stat.value}</div>
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-[#A68340]">
                #
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-[#A68340]">
                Amount
      ...
      <div className="space-y-4">
        {filteredData.map((sem) => (
          ...
          >
            ...
            >
              <div className="flex items-center space-x-4">
                <div className="w-10 h-10 bg-[#A68340]/10 rounded-full flex justify-center items-center">
                  <span className="text-[#A68340] font-semibold">
                    {sem.sem_num}
                  </span>
                </div>
                <div>
              ...
              <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-[#A68340]">{sem.sem_amount_word || "N/A"}</p>
                  </div>
                  <div>
                    <span className="text-gray-600">Due Date:</span>
                    <p className="text-[#A68340]">{sem.sem_due_date || "N/A"}</p>
                  </div>
                  <div>
                    <span className="text-gray-600">Status:</span>
                    <p className="text-[#A68340]">{sem.status || "N/A"}</p>
                  </div>
                  <div>
                    <span className="text-gray-600">Payment Type:</span>
                    <p className="text-[#A68340]">{sem.pay_type || "N/A"}</p>
                  </div>
                </div>
